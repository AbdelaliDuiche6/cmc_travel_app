...
Future<void> changRol() async{
  ...
  Future<void> _loadProfile() async {
    ...
    String createdDateFormatted =
        createdDate != null
            ? createdDate.toLocal().toString().split(" ").first
            : '';
  ...
  Widget _buildInfoRow(
    ...
    final effectiveBackgroundColor =
        backgroundColor ??
        (isHighlighted
            ? const Color(0xFF3AB796).withOpacity(0.08)
            : Colors.transparent);
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border:
            isHighlighted
                ? Border.all(
                  color: const Color(0xFF3AB796).withOpacity(0.2),
                  width: 1,
                )
                : null,
      ),
